        ...
        <section class="page-banner services-banner">
            <div class="container">
                <div class="banner-header">
                    <h2>Books & IEEE PDF listing</h2>
                    <span class="underline center"></span>
                    <p class="lead">hello there.... welcome... now without waiting you can view the PDFs saved here...Congoo!!</p>
                </div>
                <div class="breadcrumb">
                    <ul>
                        <li><a href="index.php">Home</a></li>
                        <li>Books & Media PDFs</li>
                    </ul>
                </div>
            </div>
        </section>
                            ...
                            <div class="booksmedia-fullwidth">
                                ...
                                if ($result->num_rows > 0)
                                {
                                    ...
                                    echo "<li>
                                        ...
                                        <figure>
                                            <a href=\"http://docs.google.com/gview?url=https://piyuchavare1301.000webhostapp.com/data/". $row['link'] . "&embedded=true\" target=\"_blank\" style=\"width:100%; height:700px;\" frameborder=\"0\"><img src=\"images/books-media/book.png\" alt=\"Book\"></a>
                                            <figcaption>
                                                <header>
                                                    <h4><a href=\"http://docs.google.com/gview?url=https://piyuchavare1301.000webhostapp.com/data/". $row['link'] . "&embedded=true\" target=\"_blank\" style=\"width:100%; height:700px;\" frameborder=\"0\">". $row['name'] . "</a></h4>
